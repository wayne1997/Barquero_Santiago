...
public class AlgoritmoSolucion {
    ...
    public AlgoritmoSolucion(int dim){
        ...
        this.imprimirVector(vectorInicio, vectorFin);
    }
    ...
    public void imprimirVector(int[] vector, int[] vector2){
       for(int j=0; j<vector.length; j++)System.out.println(vector[j] +"\t"+ vector2[j]);
        System.out.println("");
        System.out.println("Lado_1: " + this.monitor1 + "\t" +"Lado_2: " +this.monitor2);
    }
